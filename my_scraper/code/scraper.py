...
class AngelListScraper():
	...
	def write_entries_to_data_frame(self, 
		output_fname, start_row, N_rows, results):

		entries = []
		#XXX this seems like it would error because entries doesn't exist. 
		# Should it have a continue?
